Pod::Spec.new do |spec|
  ...
  spec.version          = '5.4.1.1'
  spec.license          = { :type => 'New BSD', :file => 'LICENSE' }
  spec.homepage         = 'https://github.com/adxcorp/mopub-ios-sdk'
  spec.authors          = { 'Eleanor Choi' => 'khchoi@adxcorp.kr' }
  ...
  spec.source           = { :git => 'https://github.com/adxcorp/mopub-ios-sdk.git', :tag => '5.4.1.1' }
